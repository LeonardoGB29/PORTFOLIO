  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 md:gap-5">
        ...
        <div>
          <h4 className="xs:text-6xl from-primary via-primary-dark flex gap-4 bg-linear-to-r from-35% via-50% to-white to-65% bg-size-[220%] bg-clip-text bg-right text-3xl font-bold text-transparent transition-all duration-700 group-hover:bg-left">
            {project.name}
